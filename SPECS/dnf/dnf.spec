...
# Note for Azure Linux - need to decide on strict or non-strict
%if 0
...
%changelog
* Sat Feb  3 10:56:54 EST 2024 Dan Streetman <ddstreet@ieee.org> - 4.18.2-2
